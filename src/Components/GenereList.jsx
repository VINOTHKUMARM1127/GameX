        ...
        return (
            <div className='my-1 rounded-lg p-2 bg-[#09152b] h-[56px] animate-pulse
             flex items-center group md:mb-2 cursor-pointer ml-[1px]'>
                ...
                <div className='bg-[#09152b] animate-pulse w-[20px]
                text-center ml-[2px] pt-2 px-8 pb-2 rounded-md'></div>
            </div>
        )
    }
                    ...
                    <div className='w-[100%] flex overflow-x-scroll md:flex-col md:w-[90%]'>
                        {genreList.map((item, key) => (
                            <div
                                ...
                                className={`rounded-lg p-2 pr-12 flex items-center group md:mb-2 cursor-pointer
                                    hover:bg-[#295fa1] ${index === key ? 'bg-[#063977]' : ''
                                    }`}
                            >
                                <img
